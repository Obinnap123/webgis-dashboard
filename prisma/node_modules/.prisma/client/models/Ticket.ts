...
export type TicketOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "description" | "status" | "priority" | "createdById" | "assignedToId" | "createdAt" | "updatedAt" | "resolvedAt", ExtArgs["result"]["ticket"]>
